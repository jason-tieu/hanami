...
const components = {
  h1: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h1
      className={cn(
        "text-4xl font-bold tracking-tight text-foreground mb-6",
        className
      )}
      {...props}
    />
  ...
  h2: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h2
      className={cn(
        "text-3xl font-semibold tracking-tight text-foreground mb-4 mt-8",
        className
      )}
      {...props}
    />
  ...
  h3: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h3
      className={cn(
        "text-2xl font-semibold tracking-tight text-foreground mb-3 mt-6",
        className
      )}
      {...props}
    />
  ...
  h4: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h4
      className={cn(
        "text-xl font-semibold tracking-tight text-foreground mb-2 mt-4",
        className
      )}
      {...props}
    />
  ...
  p: ({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) => (
    <p
      className={cn("text-muted-foreground leading-7 mb-4", className)}
      {...props}
    />
  ),
  ...
  blockquote: ({ className, ...props }: React.HTMLAttributes<HTMLQuoteElement>) => (
    <blockquote
      className={cn(
        "border-l-4 border-brand pl-4 italic text-muted-foreground my-4",
        className
      )}
      {...props}
    />
