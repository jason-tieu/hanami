  ...
  return (
    <>
      <motion.button
        ...
        className="project-card group relative w-full rounded-2xl border border-border bg-card/50 px-5 py-6 text-left outline-none focus-visible:ring-2 focus-visible:ring-accent-pink dark:border-white/10 dark:bg-white/5"
      >
        {/* ripple overlay */}
        ...
        <div className="relative mb-4 h-32 w-full overflow-hidden rounded-xl">
          ...
          />
          <div className="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-border/50 group-hover:ring-pink-500/20 dark:ring-white/10" />
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3 text-sm">
            {project.links.demo && (
              <a
                className="text-muted-foreground hover:text-brand underline-offset-4 hover:underline flex items-center gap-1 dark:text-neutral-400 dark:hover:text-pink-400"
