...
export const projects: Project[] = [
  {
    ...
    tagline:
      'AI-powered flood detection pipeline integrating CCTV imagery with GIS mapping for real-time decision support',
    description:
      'Advanced computer vision system leveraging DeepLabv3+ and GANs for automated flood monitoring and early warning systems in vulnerable regions',
  ...
  },
  {
    ...
    tagline:
      'Cloud-deployed microservice app for video upload, transcoding, and caching with scalable AWS infrastructure',
    description:
      'Full-stack video processing platform with microservices architecture, real-time transcoding, and optimized cloud deployment',
  ...
  },
  {
    ...
    tagline:
      'Full-stack ground control station for UAV payload management with real-time telemetry and visualization',
    description:
      'Comprehensive UAV control system with real-time data streaming, operator dashboards, and hardware integration',
    categories: ['Full-Stack', 'Cloud'],
    tech: [
      'Flask',
      'Socket.IO',
  ...
  },
  {
    ...
    description:
      'Embedded control system with touchscreen interface for electric vehicle dashboard and motor control',
    categories: ['Embedded'],
    tech: [
      'FreeRTOS',
      'C/C++',
  ...
  },
  {
    ...
    description:
      'Command-line application for auction data management with optimized data structures and user interaction',
    categories: ['Backend'],
  ...
  },
  {
    ...
    tagline:
      'Full-stack web app deployed on AWS using microservices architecture with scalable infrastructure',
    description:
      'Cloud-native web application with microservices architecture and cost-efficient AWS deployment',
    categories: ['Full-Stack', 'Cloud'],
  ...
  },
  {
    ...
    tagline:
      'IoT-driven data analysis for predictive air conditioning scheduling and energy optimization',
    description:
      'Data analytics solution for smart building optimization using IoT sensor data and predictive modeling',
  ...
  },
  {
    ...
    tagline:
      'Microcontroller-based Simon Says game built with low-level C and Assembly programming',
    description:
      'Embedded game development with hardware interaction and optimized microcontroller programming',
    categories: ['Embedded'],
  ...
  },
  {
    ...
    tagline:
      'Java-based scheduler for prioritizing student study tasks with intelligent time management',
    description:
      'Task management application with intelligent scheduling algorithms and OOP design principles',
    categories: ['Backend'],
  ...
  },
  {
    ...
    description:
      'Advanced puzzle-solving algorithm with optimized state representation and intelligent search strategies for Sokoban game solutions',
    categories: ['AI/ML'],
  ...
  },
  {
    ...
    tagline:
      'MATLAB pipeline for telemetry analysis of QUT Motorsport vehicles with performance optimization',
    description:
      'Advanced data analytics solution for motorsports performance analysis and race strategy optimization',
    categories: ['Data Analysis'],
