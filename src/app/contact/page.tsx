          ...
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                I&apos;m always interested in new opportunities, exciting projects, and meaningful conversations.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
              ...
              <UIButton asChild variant="primary" className="text-lg px-8 py-6">
                <Link href="https://www.linkedin.com/in/jason-tieu-engineer/" className="flex items-center gap-2">
